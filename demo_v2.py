...
def gradio_ask(user_message, chatbot, chat_state, gr_img, img_list, upload_flag, replace_flag):
    ...
    def handle_chat_response(user_message, response):
       chat_id = '01'  # This should be uniquely generated for each chat session
       images = gr_img
       questions = user_message
       answers = llm_message

    # Save to Firestore
    save_chat_session(chat_id, images, questions, answers)
...
def save_chat_session(chat_id, images, questions, answers):
    doc_ref = db.collection(u'chat').document(chat_id)
    doc_ref.set({
        u'chat_id': chat_id,
        u'images': images,
